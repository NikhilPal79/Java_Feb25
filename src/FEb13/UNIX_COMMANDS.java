...
Scrum meetings AWS - created account on aws

1 free 1 year - Free tier. 1 credit

Cloud
on demand avaialbility of compute services rent a server

Toronto --- vancouver BUY ? or rent
...
AWS - 35 % Java GCP Javscript Azure Python

Unix
1960s - 70 AT&T - Denis Ritche , Bells Labs
...
Linux
Linus Torvarld - open source- Free to sell , free to modify ,free to use

Red Hat Kali Linux Fedora Centos Ubuntu Debian CentOS
...
Motherboard
CPU
Pentium 4 core i3 Core i5

Kernel Communications between software and hardware
